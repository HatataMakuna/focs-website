...
echo "" > /log.txt
echo "{\"agent\":{\"run_as_user\":\"root\"},\"logs\":{\"logs_collected\":{\"files\":{\"collect_list\":[{\"file_path\":\"/log.txt\",\"log_group_name\":\"cloudwatch-agent-test-log-group\",\"log_stream_name\":\"{instance_id}\",\"retention_in_days\":7}]}}}}" > /amazon-cloudwatch-agent.json
