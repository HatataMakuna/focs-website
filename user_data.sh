...
echo "{\"agent\":{\"run_as_user\":\"root\"},\"logs\":{\"logs_collected\":{\"files\":{\"collect_list\":[{\"file_path\":\"/opt/aws/amazon-cloudwatch-agent/logs/amazon-cloudwatch-agent.log\",\"log_group_name\":\"cloudwatch-agent-test-log-group\",\"log_stream_name\":\"{instance_id}\",\"retention_in_days\":7}]}}}}" > /amazon-cloudwatch-agent.json
